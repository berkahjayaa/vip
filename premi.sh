...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/berkahjayaa/vip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/berkahjayaa/vip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/berkahjayaa/vip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/berkahjayaa/vip/main/"
...
TIMES="10"
CHATID="6375684006"
KEY="7187027172:AAHWA-Cf6l_-RSCAYTzN3WwyUnRhkg7TJWE"
URL="https://api.telegram.org/bot$KEY/sendMessage"
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/berkahjayaa/vip/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/berkahjayaa/vip/main/izin | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/berkahajayaa/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
